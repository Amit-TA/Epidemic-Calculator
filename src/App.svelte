...
var drag_intervention2 = function (){
  ...
  onMount(async () => {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (!(parsed.InterventionAmt === undefined)) {InterventionAmt2 = parseFloat(parsed.InterventionAmt2)}
...
<div style="height:220px;">
  ...
  <div class = "row">
    ...
    <div class="column">
      ...
      <input class="range" style="margin-bottom: 8px" type=number bind:value={D_incbation} min={0.15} max=24 step=0.0001>
      ...
      <input class="range" type=number bind:value={D_infectious} min=0 max=24 step=0.01>
    </div>
    ...
    <div class="column">
      ...
      <input class="range" style="margin-bottom: 8px" type=number bind:value={CFR} min={0} max=1 step=0.0001>
      ...
      <input class="range" type=number bind:value={Time_to_death} min={(D_infectious)+0.1} max=100 step=0.01>
    </div>
    ...
    <div class="column">
      ...
      <input class="range" style="margin-bottom: 8px" type=number bind:value={D_recovery_severe} min={0.1} max=100 step=0.01>
      ...
      <input class="range" type=number bind:value={D_recovery_mild} min=0.5 max=100 step=0.01>
    </div>
    ...
    <div class="column">
      ...
      <input class="range" style="margin-bottom: 8px" type=number bind:value={P_SEVERE} min={0} max=1 step=0.0001>      
      ...
      <input class="range" type=number bind:value={D_hospital_lag} min=0.5 max=100 step=0.01>
    </div>
